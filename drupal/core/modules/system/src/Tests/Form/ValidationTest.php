...
class ValidationTest extends WebTestBase {
  ...
  /**
   * Tests form alterations by #element_validate, #validate, and $form_state->setValueForElement().
   */
  function testValidate() {
    ...
    $this->assertNoText('Name value: value changed by $form_state->setValueForElement() in #validate', 'Form element value in $form_state was not altered.');
